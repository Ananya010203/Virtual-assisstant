...
def get_audio(): 
    ...
    with sr.Microphone() as source: 
        ...
        print("Listening") 
        #playsound(r"C:\Users\madhu\Downloads\A-GUI-Virtual-Assistant-with-python-main\A-GUI-Virtual-Assistant-with-python-main\assistant_on.wav")
        #audio = r.listen(source, phrase_time_limit = 3) 
        #playsound(r"C:\Users\madhu\Downloads\A-GUI-Virtual-Assistant-with-python-main\A-GUI-Virtual-Assistant-with-python-main\assistant_off.wav")
        print("Stop.") 
...
def Process_audio():
    ...
    if __name__=='__main__':
        while run==1:
            ...
            app_dest = r'C:\Users\madhu\AppData\Roaming\Microsoft\Windows\Start Menu\Programs'
...
def change_name_window():
      ...
      settings_screen.iconbitmap(r'C:\Users\madhu\Downloads\A-GUI-Virtual-Assistant-with-python-main\A-GUI-Virtual-Assistant-with-python-main\app_icon.ico')
...
def info():
  ...
  info_screen.iconbitmap(r'C:\Users\madhu\Downloads\A-GUI-Virtual-Assistant-with-python-main\A-GUI-Virtual-Assistant-with-python-main\app_icon.ico')

  creator_label = Label(info_screen,text = "Created by madhu")
  creator_label.pack()
...
def wikipedia_screen(text):
  ...
  wikipedia_screen.iconbitmap(r'C:\Users\madhu\Downloads\A-GUI-Virtual-Assistant-with-python-main\A-GUI-Virtual-Assistant-with-python-main\app_icon.ico')
...
def main_screen():
      ...
      screen.iconbitmap(r'C:\Users\madhu\Downloads\A-GUI-Virtual-Assistant-with-python-main\A-GUI-Virtual-Assistant-with-python-main\app_icon.ico')
      ...
      microphone_photo = PhotoImage(file = r"C:\Users\madhu\Downloads\A-GUI-Virtual-Assistant-with-python-main\A-GUI-Virtual-Assistant-with-python-main\assistant_logo.png")
      microphone_button = Button(image=microphone_photo, command = Process_audio)
      microphone_button.pack(pady=10)

      settings_photo = PhotoImage(file = r"C:\Users\madhu\Downloads\A-GUI-Virtual-Assistant-with-python-main\A-GUI-Virtual-Assistant-with-python-main\settings.png")
